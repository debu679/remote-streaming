...
int remotehost_WebM_pipeline (int argc, char *argv[]) {
    GstBus *bus;
    ...
    if (!remote_host.pipeline || !remote_host.udp_video_source || !remote_host.video_rtp_depay || !remote_host.video_rtp_buffer || !remote_host.video_watchdog ||
        !remote_host.video_decoder || !remote_host.video_queue || !remote_host.video_convert || !remote_host.video_sink || !remote_host.audio_watchdog ||
    ...
    /* Add elements to bin */ 
    gst_bin_add_many(GST_BIN(remote_host.pipeline),remote_host.udp_video_source, remote_host.video_rtp_buffer, remote_host.video_rtp_depay, remote_host.video_watchdog,
                            remote_host.video_decoder, remote_host.video_queue, remote_host.video_convert, remote_host.video_sink, remote_host.audio_watchdog,
                            remote_host.udp_audio_source, remote_host.audio_rtp_buffer, remote_host.audio_rtp_depay, remote_host.audio_decoder,
    ...
    if(gst_element_link_many(remote_host.udp_video_source, remote_host.video_watchdog, remote_host.video_rtp_buffer, remote_host.video_rtp_depay,
    ...
    if(gst_element_link_many(remote_host.udp_audio_source, remote_host.audio_watchdog, remote_host.audio_rtp_buffer, remote_host.audio_rtp_depay,
